...
import { type DevIconNameType, devicons } from '@/lib/icons/dev'
...
export const Icon: FC<IconProps> = ({ name, className, size = 16, color = 'currentColor', solid = true, ...props }) => {
  const icon = icons[name as IconNameType] ?? logos[name as LogoNameType] ?? devicons[name as DevIconNameType]
